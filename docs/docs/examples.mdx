...
import ThreeDReflexAngleExample from '@site/src/components/examples/ThreeDReflexAngleExample';
import ApplyMatrixArrowsExample from '@site/src/components/examples/ApplyMatrixArrowsExample';
import ApplyMatrixMethodExample from '@site/src/components/examples/ApplyMatrixMethodExample';
...
**Learn More:** [**Square**](/api/classes/Square) · [**Circle**](/api/classes/Circle) · [**FadeIn**](/api/classes/FadeIn)
