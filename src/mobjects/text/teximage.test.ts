...
describe('MathTexImage', () => {
  ...
  describe('copy', () => {
    it('should create an independent copy of single-part', () => {
      const original = new MathTexImage({ latex: 'x^2', color: '#ff0000', fontSize: 64 });
  ...
  describe('multi-part edge cases', () => {
    it('should set displayMode to false for child parts', () => {
      const tex = new MathTexImage({ latex: ['x', '=', '5'], displayMode: true });
  ...
  describe('MathJax ex-unit SVG dimensions', () => {
    it('should convert ex-unit dimensions to reasonable pixel sizes', async () => {
      ...
      const tex = new MathTexImage({ latex: 'x^2', renderer: 'mathjax', fontSize: 48 });
