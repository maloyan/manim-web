...
describe("MathTexImage", () => {
  ...
  describe("constructor", () => {
    ...
    it("should accept an empty latex string", () => {
      const tex = new MathTexImage({ latex: "" });
    ...
    it("should accept custom fontSize", () => {
      const tex = new MathTexImage({ latex: "a", fontSize: 72 });
    ...
    it("should accept renderer option katex", () => {
      const tex = new MathTexImage({ latex: "a", renderer: "katex" });
      expect(tex.getRenderer()).toBe("katex");
    });

    it("should accept renderer option mathjax", () => {
      const tex = new MathTexImage({ latex: "a", renderer: "mathjax" });
    ...
    it("should accept custom color", () => {
      const tex = new MathTexImage({ latex: "a", color: "#ff0000" });
      expect(tex.color).toBe("#ff0000");
    });

    it("should set position from options", () => {
      const tex = new MathTexImage({ latex: "a", position: [1, 2, 3] });
  ...
  describe("multi-part constructor", () => {
    it("should create multi-part from string array", () => {
      const tex = new MathTexImage({ latex: ["x", "=", "42"] });
  ...
  describe("getLatex / setLatex", () => {
    it("should return the latex string", () => {
      const tex = new MathTexImage({ latex: "y = mx + b" });
  ...
  describe("getFontSize / setFontSize", () => {
    it("should return fontSize", () => {
      const tex = new MathTexImage({ latex: "a", fontSize: 64 });
    ...
    it("should not re-render when setting same fontSize", () => {
      const tex = new MathTexImage({ latex: "a", fontSize: 48 });
  ...
  describe("getRenderer / setRenderer", () => {
    ...
    it("should not re-render when setting same renderer", () => {
      const tex = new MathTexImage({ latex: "a", renderer: "auto" });
  ...
  describe("getPart / getPartCount", () => {
    it("should return 1 for single-string MathTexImage", () => {
      const tex = new MathTexImage({ latex: "E = mc^2" });
      expect(tex.getPartCount()).toBe(1);
    });
    ...
    it("should return child MathTexImage for valid index", () => {
      const tex = new MathTexImage({ latex: ["x", "=", "5"] });
      const part = tex.getPart(0);
      expect(part).toBeInstanceOf(MathTexImage);
    ...
    it("should throw for getPart on single-string MathTexImage", () => {
      const tex = new MathTexImage({ latex: "x" });
      expect(() => tex.getPart(0)).toThrow(
        "getPart() is only available on multi-part MathTexImage",
      );
    });
  ...
  describe("setStrokeOpacity", () => {
    ...
    it("should propagate opacity to multi-part children", () => {
      ...
      expect((partA as unknown as { _opacity: number })._opacity).toBeCloseTo(
        0.3,
      );
      expect((partB as unknown as { _opacity: number })._opacity).toBeCloseTo(
        0.3,
      );
    });
  });
  ...
  describe("copy", () => {
    it("should create an independent copy of single-part", () => {
      const original = new MathTexImage({
        latex: "x^2",
        color: "#ff0000",
        fontSize: 64,
      });
      const clone = original.copy() as MathTexImage;
      expect(clone).toBeInstanceOf(MathTexImage);
    ...
    it("should create an independent copy (modifying copy does not affect original)", () => {
      const original = new MathTexImage({ latex: "a" });
      const clone = original.copy() as MathTexImage;
      clone.setLatex("b");
    ...
    it("should preserve renderer setting in copy", () => {
      const original = new MathTexImage({ latex: "a", renderer: "katex" });
      const clone = original.copy() as MathTexImage;
      expect(clone.getRenderer()).toBe("katex");
    });

    it("should create copy of multi-part MathTexImage", () => {
      const original = new MathTexImage({ latex: ["x", "=", "5"] });
      const clone = original.copy() as MathTexImage;
  ...
  describe("getActiveRenderer", () => {
    it("should initially be null before render completes", () => {
      ...
      expect(active === null || active === "katex" || active === "mathjax")
        .toBe(true);
    });
  });
  ...
  describe("setRevealProgress", () => {
    ...
    it("should not throw on multi-part", () => {
      const tex = new MathTexImage({ latex: ["a", "b", "c"] });
  ...
  describe("getThreeObject / _createThreeObject", () => {
    ...
    it("should have correct mesh material with opacity and color", () => {
      const tex = new MathTexImage({ latex: "y", color: "#ff0000" });
    ...
    it("calling getThreeObject twice returns same object", () => {
      const tex = new MathTexImage({ latex: "z" });
  ...
  describe("_updateMeshGeometry", () => {
    it("should not throw when called with no mesh", () => {
      ...
      const protectedTex = tex as unknown as {
  ...
  describe("_startRender error handling", () => {
    it("should handle render failure gracefully", () => {
      // MathTexImage should not throw even if rendering fails
      const tex = new MathTexImage({ latex: "x" });
      expect(tex.isRendering()).toBe(true);
  ...
  describe("setRevealProgress with mesh state", () => {
    it("should handle sequential reveal progress calls", () => {
      const tex = new MathTexImage({ latex: "hello" });
      expect(() => {
    ...
    it("should handle multi-part reveal progress sequentially per part", () => {
      const tex = new MathTexImage({ latex: ["a", "b", "c", "d"] });
      expect(() => {
  ...
  describe("multi-part edge cases", () => {
    it("should set displayMode to false for child parts", () => {
      ...
      expect((part as unknown as { _displayMode: boolean })._displayMode).toBe(
        false,
      );
    });
    ...
    it("should inherit color in child parts", () => {
      const tex = new MathTexImage({ latex: ["x", "y"], color: "#ff0000" });
      expect(tex.getPart(0).color).toBe("#ff0000");
      expect(tex.getPart(1).color).toBe("#ff0000");
    });

    it("should inherit fontSize in child parts", () => {
      const tex = new MathTexImage({ latex: ["a", "b"], fontSize: 72 });
    ...
    it("should inherit renderer in child parts", () => {
      const tex = new MathTexImage({ latex: ["a", "b"], renderer: "mathjax" });
    ...
    it("waitForRender waits for all parts", async () => {
      const tex = new MathTexImage({ latex: ["x", "y"] });
  ...
  describe("copy edge cases", () => {
    it("should preserve displayMode in copy", () => {
      const original = new MathTexImage({ latex: "x", displayMode: false });
      const clone = original.copy() as MathTexImage;
      // displayMode should be preserved
      expect((clone as unknown as { _displayMode: boolean })._displayMode).toBe(
        false,
      );
    });

    it("should preserve position in copy", () => {
      const original = new MathTexImage({ latex: "x", position: [1, 2, 3] });
      const clone = original.copy() as MathTexImage;
  ...
  describe("katex styles loading", () => {
    ...
    it("calls ensureKatexStyles for auto renderer", () => {
      const tex = new MathTexImage({ latex: "x", renderer: "auto" });
      expect(tex.getRenderer()).toBe("auto");
    });
  });
  ...
  describe("_padding option", () => {
    ...
    it("should accept custom _padding", () => {
      const tex = new MathTexImage({ latex: "x", _padding: 20 });
  ...
  describe("MathJax ex-unit SVG dimensions", () => {
    it("should convert ex-unit dimensions to reasonable pixel sizes", async () => {
      ...
      vi.spyOn(await import("./MathJaxRenderer"), "renderLatexToSVG")
        .mockResolvedValue({
          svgElement: (() => {
