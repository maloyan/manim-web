  ...
  describe("doubleSmooth", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(doubleSmooth(t2)).toBeGreaterThanOrEqual(
          doubleSmooth(t1) - EPSILON,
        );
      }
    });
  ...
  describe("smootherstep", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(smootherstep(t2)).toBeGreaterThanOrEqual(
          smootherstep(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("smoothererstep", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(smoothererstep(t2)).toBeGreaterThanOrEqual(
          smoothererstep(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("easeOutSine", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(easeOutSine(t2)).toBeGreaterThanOrEqual(
          easeOutSine(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("easeInOutSine", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(easeInOutSine(t2)).toBeGreaterThanOrEqual(
          easeInOutSine(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("easeInOutQuad", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(easeInOutQuad(t2)).toBeGreaterThanOrEqual(
          easeInOutQuad(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("easeInOutExpo", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(easeInOutExpo(t2)).toBeGreaterThanOrEqual(
          easeInOutExpo(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("easeOutCirc", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(easeOutCirc(t2)).toBeGreaterThanOrEqual(
          easeOutCirc(t1) - EPSILON,
        );
      }
    });
  });
  ...
  describe("easeInOutCirc", () => {
    ...
    it("should be monotonically increasing", () => {
      ...
      for (let i = 0; i < steps; i++) {
        const t1 = i / steps;
        const t2 = (i + 1) / steps;
        expect(easeInOutCirc(t2)).toBeGreaterThanOrEqual(
          easeInOutCirc(t1) - EPSILON,
        );
      }
    });
  });
