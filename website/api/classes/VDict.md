...
Defined in: [core/VDict.ts:35](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L35)
...
> **new VDict**(`items`): `VDict`

Defined in: [core/VDict.ts:45](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L45)
...
`Record`\<`string`, [`VMobject`](VMobject.md)\> = `{}`

Object mapping names to VMobjects
...
Defined in: [core/VDict.ts:168](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L168)
...
Defined in: [core/VDict.ts:206](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L206)
...
> **addNamed**(`name`, `vmobject`): `this`

Defined in: [core/VDict.ts:247](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L247)
...
> **asProxy**(): `VDict` & `object`

Defined in: [core/VDict.ts:178](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L178)
...
A proxy allowing bracket access like vdict['key']
...
Defined in: [core/VDict.ts:157](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L157)
...
Defined in: [core/VDict.ts:213](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L213)
...
Defined in: [core/VDict.ts:99](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L99)
...
Name/key of the VMobject to remove
...
> **entries**(): `IterableIterator`\<\[`string`, [`VMobject`](VMobject.md)\]\>

Defined in: [core/VDict.ts:129](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L129)

Get all entries as [key, VMobject] pairs.

#### Returns

`IterableIterator`\<\[`string`, [`VMobject`](VMobject.md)\]\>

Iterator of [key, VMobject] tuples
...
Defined in: [core/VDict.ts:139](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L139)
...
Callback function receiving (vmobject, index)
...
> **forEachEntry**(`fn`): `this`

Defined in: [core/VDict.ts:148](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L148)
...
(`vmobject`, `key`, `dict`) => `void`

Callback function receiving (vmobject, key, dict)
...
> **get**(`keyOrIndex`): [`VMobject`](VMobject.md)

Defined in: [core/VDict.ts:59](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L59)
...
Name/key of the VMobject (string) or index (number)
...
The VMobject, or undefined if not found
...
> **getByName**(`name`): [`VMobject`](VMobject.md)

Defined in: [core/VDict.ts:278](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L278)
...
> **getItem**(`name`): [`VMobject`](VMobject.md)

Defined in: [core/VDict.ts:268](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L268)
...
Defined in: [core/VDict.ts:90](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L90)
...
Defined in: [core/VDict.ts:113](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L113)
...
> **removeNamed**(`name`): `this`

Defined in: [core/VDict.ts:257](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L257)
...
> **set**(`key`, `vmobject`): `this`

Defined in: [core/VDict.ts:74](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L74)
...
> **values**(): `IterableIterator`\<[`VMobject`](VMobject.md)\>

Defined in: [core/VDict.ts:121](https://github.com/maloyan/manim-js/blob/bb3df540431462df8cb4b68d80f4f748b060aefb/src/core/VDict.ts#L121)

Get all VMobjects in the VDict.

#### Returns

`IterableIterator`\<[`VMobject`](VMobject.md)\>

Iterator of VMobjects
