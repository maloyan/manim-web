...
Defined in: [core/VMobject.ts:32](https://github.com/maloyan/manim-js/blob/c05b6757c237b624c0c3a6b2afda7111f378c148/src/core/VMobject.ts#L32)
...
- [`VGroup`](VGroup.md)
- [`VectorizedPoint`](VectorizedPoint.md)
...
- [`Ellipse`](Ellipse.md)
- [`Annulus`](Annulus.md)
- [`AnnularSector`](AnnularSector.md)
- [`Sector`](Sector.md)
- [`ArcPolygon`](ArcPolygon.md)
- [`CurvedArrow`](CurvedArrow.md)
- [`CurvedDoubleArrow`](CurvedDoubleArrow.md)
- [`DashedLine`](DashedLine.md)
- [`CubicBezier`](CubicBezier.md)
- [`SurroundingRectangle`](SurroundingRectangle.md)
- [`Cross`](Cross.md)
- [`RoundedRectangle`](RoundedRectangle.md)
- [`Star`](Star.md)
- [`RegularPolygram`](RegularPolygram.md)
- [`Cutout`](Cutout.md)
- [`ConvexHull`](ConvexHull.md)
- [`Angle`](Angle.md)
- [`RightAngle`](RightAngle.md)
- [`Elbow`](Elbow.md)
- [`TangentLine`](TangentLine.md)
- [`BooleanResult`](BooleanResult.md)
- [`NumberLine`](NumberLine.md)
- [`FunctionGraph`](FunctionGraph.md)
- [`ImplicitFunction`](ImplicitFunction.md)
- [`ParametricFunction`](ParametricFunction.md)
- [`Text`](Text.md)
- [`DecimalNumber`](DecimalNumber.md)
- [`GlyphVMobject`](GlyphVMobject.md)
- [`Brace`](Brace.md)
- [`BraceBetweenPoints`](BraceBetweenPoints.md)
- [`ArcBrace`](ArcBrace.md)
- [`VMobjectFromSVGPath`](VMobjectFromSVGPath.md)
...
Defined in: [core/VMobject.ts:121](https://github.com/maloyan/manim-js/blob/c05b6757c237b624c0c3a6b2afda7111f378c148/src/core/VMobject.ts#L121)
