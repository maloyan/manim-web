...
import { ThreeDAxes, ThreeDScene, Group, RED_D, RED_E } from 'manim-js';
...
```typescript
import { ThreeDAxes, ThreeDScene, Surface3D, ORANGE, BLUE } from 'manim-js';
...
```typescript
import { Circle, ThreeDAxes, ThreeDScene } from 'manim-js';
